      ...
      <div className="create-test-layout">
        <div className="create-test-content">
          <div className="form-group">
            ...
            <div className="ai-prompt-section" style={{ marginTop: 16 }}>
              <div className="ai-prompt-header">
                <h3>📐 General MCQ Format</h3>
                <p>Quick template for formatting individual MCQs (useful when splitting/pasting)</p>
              </div>
            ...
            {isAutoNaming && (
              <div className="name-status-text">Setting next available test name...</div>
                ...
                <button
                  ...
                  onClick={() => {
                    const prompt = `1. Question text here?\nA) Option A\nB) Option B\nC) Option C\nD) Option D\n\nAnswer Key:\n1-A\n2-C\n3-D\n...`
                    navigator.clipboard.writeText(prompt)
                    alert('General MCQ format copied to clipboard!')
                  }}
                >
